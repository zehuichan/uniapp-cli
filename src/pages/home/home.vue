<template>
  <view class="home">
    <view class="search-bar fixed">
      ...
      <view class="search-icon tap-active" @click="onClick('../home/comments')">
      ...
      <view class="swiper-box">
        <swiper circular autoplay interval="3000" duration="500" @change="swiperChange">
          <swiper-item v-for="(item, index) in banner" :key="index">
            <van-image width="100%" height="420rpx" lazy-load :src="item.imgUrl"></van-image>
          </swiper-item>
        </swiper>
        <view class="indicator box-shadow light">
          <view class="dots" v-for="(swiper, index) in banner.length" :class="[current_swiper >= index ? 'on' : '']"
                :key="index"></view>
        </view>
      </view>
    </view>
    <view class="banner">
      <view class="inner">
        <van-image width="100%" height="170rpx"
                   src="https://mall.s.maizuo.com/80a7da098548191c431dfd09c50f9e4b.jpg?x-oss-process=image/resize,w_563"></van-image>
      </view>
    </view>
    ...
    <view class="topic" v-for="(elem, index) in topics" :key="index">
      ...
      <view class="topic-banner box-shadow light">
